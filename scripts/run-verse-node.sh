...
misc_flags="--sequencer.enabled --l1.epoch-poll-interval=6s --p2p.disable --rpc.enable-admin --p2p.sequencer.key=${GS_SEQUENCER_PRIVATE_KEY} --sequencer.l1-confs=5 --verifier.l1-confs=4"
